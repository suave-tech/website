const SuccessSvg = () => {
  return (
    <svg style={{ marginLeft: '0', borderRadius: '0', width: 'auto', height: 'auto', padding: '0', backgroundColor: 'auto' }} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="24px" height="24px">
